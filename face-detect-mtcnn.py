...
def faceProcessor():
    ...
    while True:
        if isProcessingFrame == False:
            ...
            # Perform inference with MTCNN
            results = detector.detect_faces(frameToProcess)
...
if __name__ == '__main__':
    ...
    c0 = Thread(target=capture, args=['rtsp://admin:cctv1234@192.168.88.14:554/11', 1280, 720], daemon=True).start()
